    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 *
                 * Intentionally empty: this app's code lives in git and uploaded media
                 * lives on S3 (spatie/laravel-medialibrary), so only the database is
                 * worth backing up here. Add paths if you ever need file backups.
                 */
                'include' => [],
