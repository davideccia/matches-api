...
use App\Http\Middleware\PulseBasicAuth;
...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Pulse Basic Auth Credentials
    |--------------------------------------------------------------------------
    |
    | HTTP Basic Auth credentials for the dashboard, checked by PulseBasicAuth
    | in addition to the viewPulse gate (see AppServiceProvider), the same
    | belt-and-braces pattern used by Horizon and Log Viewer.
    |
    */

    'basic_auth_username' => env('PULSE_USERNAME'),

    'basic_auth_password' => env('PULSE_PASSWORD'),
